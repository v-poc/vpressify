...
// routes
export const ROUTES_MODULE_ID = "/@vpressify/routes";

// mdx demo
export const MDX_DEMO_RE = /<Demo\s+src=["'](.*?)["']/;
export const DEMO_MODULE_ID_PREFIX = "/@vpressify/demo/";

// mdx code demo
export const CODE_DEMO_MODULE_ID_PREFIX = "/@vpressify/code-demo/";

// mdx tsInfo
export const MDX_TS_INFO_RE =
  /<TsInfo\s+src=["'](.*?)["']\s+name=["'](.*?)["']/;
export const TS_INFO_MODULE_ID_PREFIX = "/@vpressify/ts-info/";

// theme
export const THEME_MODULE_ID = "/@vpressify/theme";
export const THEME_CONFIG_MODULE_ID = "/@vpressify/theme-config";
...
export const SLIDE_MODULE_ID_PREFIX = "/@vpressify/slide/";
