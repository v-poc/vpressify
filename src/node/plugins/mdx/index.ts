  ...
  return {
    ...
    async transform(code, id, opts) {
      if (
        ...
        viteReactPlugin?.transform?.handler
      ) {
  ...
  return {
    ...
    resolveId(source) {
      ...
      if (source.startsWith(DEMO_MODULE_ID_PREFIX)) {
        ...
        //   throw new Error(
        //     `[vpressify] Cannot resolve demo: '${filePath}'. importer: '${importer}'`
        //   );
        // }
